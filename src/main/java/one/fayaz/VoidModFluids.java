...
public class VoidModFluids {
    ...
    public static void register() {
        ...
        VOID_BLOCK = Registry.register(Registries.BLOCK,
                ...
                new FluidBlock(VoidModFluids.VOID, AbstractBlock.Settings
                        .copy(Blocks.WATER)
        ...
        VOID_BUCKET = Registry.register(Registries.ITEM,
                Identifier.of(ViscousVoid.MOD_ID, "void_bucket"), new BucketItem(VoidModFluids.VOID, new Item.Settings()
